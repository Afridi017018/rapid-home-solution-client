...
const ContactUs = () => {
    return (
        <div className='container mx-auto mt-20 md:mt-36 pb-10'>
            <div className='bg-gradient-to-r from-green-500 to-green-200 py-16 relative lg:px-20'>
                <div className='w-1/2'>
                <h4 className='text-xl font-bold text-white text-center'>If you are unable to locate the service you're looking for, feel free to reach out to us anytime at 16516, available 24/7.</h4>
