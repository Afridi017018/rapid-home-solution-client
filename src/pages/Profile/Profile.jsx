...
const Profile = () => {
  ...
  return (
    <div className='px-5 lg:px-24'>
      <div className="mx-auto m-10 p-6 bg-red-100 rounded-md">
        <h2 className="text-2xl font-bold mb-4 text-center underline underline-offset-4 text-red-900">Profile</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className='text-center'>
            <button
              type="submit"
              className="bg-red-800 hover:bg-red-950 text-white font-bold py-2 px-10 rounded focus:outline-none focus:shadow-outline"
            >
              Submit
            </button>
          </div>
